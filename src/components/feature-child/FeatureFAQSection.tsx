  ...
  return (
    <SectionContainer className="items-center md:items-start w-full">
      <div className="w-full flex flex-col md:flex-row border-t">
        <div className="border-[#e5e7eb] border-r border-b flex flex-col gap-4 items-center md:items-start justify-center md:justify-start px-4 md:px-8 lg:px-16 py-8 md:py-10 lg:py-14 relative shrink-0 w-full md:w-1/2">
