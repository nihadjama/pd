...
export default function IntegrationHeroSection({
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4 py-32 lg:px-16">
      <div className="relative z-10 flex w-full max-w-[768px] flex-col items-center gap-12">
        {/* Main Content Card */}
        <div className="border border-[#e5e7eb] flex flex-col items-start p-12 w-full">
