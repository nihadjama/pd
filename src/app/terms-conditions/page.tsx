        ...
        <div className="w-full px-4 lg:px-16 py-12 md:py-16 lg:py-20">
          <div className="max-w-4xl mx-auto flex flex-col gap-8 md:gap-10">
            ...
            <section className="flex flex-col gap-4">
              ...
              <p className="font-sans font-normal text-base leading-6 text-foreground">
                If you have any question regarding the use of the website or AppDilly services, please e-mail us at <a href="mailto:info@appdilly.com" className="text-primary hover:underline">info@appdilly.com</a>
              </p>
            </section>
